...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Do you want to download Development Builds or Stable Builds? You can change this later in Options -&gt; Launcher tab. (Yes = Development, No = Stable).
        '''</summary>
